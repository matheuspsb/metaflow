...
export function FeatureChip({ Icon, title, sub }: FeatureChipProps) {
  return (
    <div className="bg-chip-bg border-chip-border hover:border-chip-border-hover hover:bg-chip-bg-hover flex cursor-default items-center gap-3 rounded-lg border px-4 py-3 backdrop-blur-sm transition-all duration-250 ease-[ease] hover:-translate-y-0.5">
