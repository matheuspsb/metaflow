...
export function SidebarLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <aside
        className={cn(
          'border-border-subtle bg-bg-sidebar fixed inset-y-0 left-0 z-50 flex h-screen w-60 shrink-0 flex-col border-r transition-transform duration-300 ease-in-out',
