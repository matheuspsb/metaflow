...
export const EVENTS: Record<string, CalendarEvent[]> = {
  ...
  '2026-05-06': [
    { id: 7, title: 'All Hands', time: '14:00', dur: 60, cat: 'Work' },
  ],
  '2026-05-07': [
  ...
  '2026-05-08': [
    { id: 10, title: 'Jantar família', time: '19:30', dur: 120, cat: 'Personal' },
  ],
  '2026-05-11': [
    { id: 11, title: 'Workshop UX', time: '09:00', dur: 240, cat: 'Work' },
  ],
  '2026-05-15': [
    { id: 12, title: 'Aniversário Marina', time: '20:00', dur: 180, cat: 'Personal' },
  ],
}
